...
public class PickupObject : MonoBehaviour
{
    ...
    private void UpdateScale()
    {
        ...
        Vector3 newPos = playerCamera.ViewportToWorldPoint(new Vector3(_orgViewportPos.x, _orgViewportPos.y,
    ...
    public void OnPickup()
    {
        ...
        _orgViewportPos = playerCamera.WorldToViewportPoint(_heldObject.position);
    ...
    private void GetRectConfines(Vector3[] bbPoints)
    {
        ...
        for (int i = 0; i < bbPoints.Length; i++)
        {
            ...
            viewportPoint = playerCamera.WorldToViewportPoint(bbPoint);
    ...
    private RaycastHit CastTowardsGridPoint(Vector3 gridPoint, LayerMask layers)
    {
        ...
        Vector3 origin = playerCamera.WorldToViewportPoint(worldPoint);
        origin.z = 0;
        origin = playerCamera.ViewportToWorldPoint(origin);
